...
function Hero() {
  return (
    <div className="flex-1 mx-auto mt-auto gap-6 flex flex-col">
      <p className=" text-6xl font-semibold text-white text-center">Unlock Your Full Potential</p>
      <p className=" text-6xl font-semibold text-white text-center">with Smart Learning</p>
