...
function Hero() {
  return (
    <div className="flex-1 mx-auto gap-6 flex flex-col">
      <p className=" text-6xl max-lg:text-4xl max-lg:px-1 font-semibold text-white text-center ">Unlock Your Full Potential</p>
      <p className=" text-6xl max-lg:text-4xl max-lg:px-1 font-semibold text-white text-center">with Smart Learning</p>
      ...
      <Image src={bend} alt="bend" className="mx-auto mb-10" />
    </div>
  );
}   
export default Hero;